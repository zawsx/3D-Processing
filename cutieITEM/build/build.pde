...
void setup(){
  ...
  colorsHearts.add(#660000,4); // inject some much darker hearts
  ...
  colorsText.add(#FFFFFF,20); // inject some more instances of all-white 'Cutie' text

	pool = new HDrawablePool(7000);
	pool.autoAddToStage()
...
void draw() {
  ...
  saveFrame("cuties/thinkITEM-###.png"); // Saves each frame as line-000001.png, line-000002.png, etc.
}